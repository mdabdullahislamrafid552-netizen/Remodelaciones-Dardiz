    ...
    <div className="bg-[#f8f9fa]">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-4xl">
            ...
            >
              <span className="block text-[#D49800] font-sans font-medium tracking-[0.3em] uppercase text-sm mb-6">
                Panamá
              </span>
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-light text-white leading-[1.1] tracking-tight mb-8">
                Diseño y <br />
            ...
            >
              <Link
                to="/contacto"
                className="group relative inline-flex items-center justify-center px-8 py-4 text-sm font-medium tracking-widest text-white uppercase bg-[#D49800] overflow-hidden"
              >
              ...
              <Link
                to="/proyectos"
                className="group inline-flex items-center justify-center px-8 py-4 text-sm font-medium tracking-widest text-white uppercase border border-white/30 hover:bg-white hover:text-black transition-colors duration-500"
              >
                Ver Portafolio
              </Link>
            </motion.div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-display font-light text-[#0a0a0a] leading-tight mb-8">
              ...
              <Link to="/nosotros" className="inline-flex items-center text-sm font-bold tracking-widest uppercase text-[#0a0a0a] group">
            ...
            <div className="relative">
              <motion.img 
                ...
                referrerPolicy="no-referrer"
              />
              <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-[#f8f9fa] hidden md:flex items-center justify-center p-8 border border-gray-100">
                <div className="text-center">
                  <span className="block text-4xl font-display font-medium text-[#D49800]">10+</span>
                  <span className="block text-xs font-bold tracking-widest text-gray-500 uppercase mt-2">Años de<br/>Excelencia</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-light">Nuestros Servicios</h2>
            </div>
            <Link to="/servicios" className="hidden md:inline-flex items-center text-sm font-bold tracking-widest uppercase text-white group">
              Ver todos
          ...
          <div className="border-t border-gray-800">
            {services.map((service, index) => (
              <motion.div 
                ...
                className="group border-b border-gray-800 py-10 hover:bg-white/5 transition-colors duration-500 px-4 -mx-4"
              >
                <Link to="/servicios" className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  <div className="md:col-span-1 text-gray-600 font-display text-xl">
                    {service.number}
                  </div>
                  <div className="md:col-span-5">
                    <h3 className="text-2xl md:text-3xl font-display font-light group-hover:text-[#D49800] transition-colors duration-500">
                      {service.title}
                    </h3>
                  </div>
                  <div className="md:col-span-5">
      ...
      <section className="py-32 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-display font-light text-[#0a0a0a]">Proyectos Destacados</h2>
          </div>
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm tracking-widest text-gray-500 uppercase">Remodelación Integral</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-sm tracking-widest text-gray-500 uppercase">Acabados</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="text-center mt-20">
            <Link to="/proyectos" className="inline-flex items-center text-sm font-bold tracking-widest uppercase text-[#0a0a0a] group">
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-display font-light text-[#0a0a0a] mb-8 leading-tight">
            ¿Listo para elevar <br/>su espacio?
          </h2>
          ...
          <Link
            to="/contacto"
            className="inline-block bg-[#0a0a0a] text-white px-10 py-5 text-sm font-medium tracking-widest uppercase hover:bg-[#D49800] transition-colors duration-500"
          >
