      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-display font-light text-[#0a0a0a] leading-tight mb-8">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <span className="block text-4xl font-display font-medium text-[#0a0a0a] mb-2">10+</span>
                  <span className="text-xs tracking-widest text-gray-500 uppercase">Años de Exp.</span>
                </div>
                <div>
                  <span className="block text-4xl font-display font-medium text-[#0a0a0a] mb-2">500+</span>
                  <span className="text-xs tracking-widest text-gray-500 uppercase">Proyectos</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="prose prose-lg text-gray-500 font-light leading-relaxed max-w-none">
                <p className="text-2xl text-[#0a0a0a] font-display font-light leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-12 border-t border-gray-200">
                <div>
                  ...
                  <p className="text-gray-500 font-light">Transformar espacios mediante soluciones arquitectónicas y constructivas de excelencia, superando las expectativas de nuestros clientes en cada detalle.</p>
                </div>
                <div>
                  <h3 className="text-xl font-display font-medium text-[#0a0a0a] mb-4">Visión</h3>
                  <p className="text-gray-500 font-light">Ser la firma referente en Panamá para proyectos de remodelación y construcción de alto perfil, reconocidos por nuestra innovación y calidad intransigente.</p>
                </div>
              </div>
            </motion.div>
